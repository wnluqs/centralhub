...
<div class="container">
    ...
    <p style="color: rgb(28, 98, 228); font-size: 20px">The team operation consist of multiple factions from on-site work, R&D and
        Stuff</p>
    ...
    <div class="row">
        ...
        <!-- Icon 8: First Ticket Last Ticket -->
        <div class="col-md-4 mb-4">
