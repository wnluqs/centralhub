...
@section('content')
    <div class="container">
        ...
        <form action="{{ route('technical.complaints.attend.submit', $complaint->id) }}" method="POST"
            ...
            <div class="mb-3">
                ...
                @php
                    $types = $complaint->types_of_damages;
                @endphp
                <input type="text" class="form-control"
                    value="{{ $types && is_array($types) ? implode(', ', $types) : $types }}">
            </div>
